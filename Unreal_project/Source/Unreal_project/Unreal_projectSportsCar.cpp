...
#include "Unreal_projectSportsCar.h"
#include "Unreal_projectSportsWheelFront.h"
#include "Unreal_projectSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AUnreal_projectSportsCar::AUnreal_projectSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UUnreal_projectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UUnreal_projectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UUnreal_projectSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UUnreal_projectSportsWheelRear::StaticClass();
