...
#include "Unreal_projectOffroadCar.h"
#include "Unreal_projectOffroadWheelFront.h"
#include "Unreal_projectOffroadWheelRear.h"
...
AUnreal_projectOffroadCar::AUnreal_projectOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UUnreal_projectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UUnreal_projectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UUnreal_projectOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UUnreal_projectOffroadWheelRear::StaticClass();
