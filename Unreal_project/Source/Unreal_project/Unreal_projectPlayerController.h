...
#include "Unreal_projectPlayerController.generated.h"

class UInputMappingContext;
class AUnreal_projectPawn;
class UUnreal_projectUI;
...
class AUnreal_projectPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<AUnreal_projectPawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<AUnreal_projectPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, Category="Vehicle|UI")
	TSubclassOf<UUnreal_projectUI> VehicleUIClass;

	/** Pointer to the UI widget */
	UPROPERTY()
	TObjectPtr<UUnreal_projectUI> VehicleUI;
